    ...
    <div name="contact" className="w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white">
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            ...
            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/e9753a2b-2adc-4042-afa1-9cee8f59b9a0" method="POST" className="flex flex-col w-full md:w1/2">
                    <input type="text" 
                    name="name" 
                    ...
                    <button className="text-white bg-gradient-to-r from-cyan-600 to-blue-500 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-105 duration-300">Submit</button>
                </form>
            </div>
        </div>
    </div>
